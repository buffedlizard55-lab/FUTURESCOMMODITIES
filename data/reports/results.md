...
Generated 2026-09-24T06:36:46.112Z from the committed ledger. Season season-2026-09-22_to_2027-09-22 (2026-09-22T00:00:00Z to 2027-09-22T00:00:00Z), 12 ticks completed.
...
Independent verification: **193/304** trades fully verified, 111 anomalies (see `data/verification/report.json`).

## Leaderboard

| # | Username | Market type | Equity (USD) | Return % | Realized | Unrealized | Fees | Slippage | Open | Closed trades |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | @metal-trend | Exchange-listed commodity future | 100983.99 | 0.98 | 0.00 | 1020.74 | 6.57 | 676.33 | 12 | 0 |
| 2 | @basis-hunter | Cross-venue: Kalshi perpetual future vs exchange-listed future | 100173.92 | 0.17 | 0.00 | 306.07 | 24.49 | 87.27 | 2 | 2 |
| 3 | @usd-rub-desk | Exchange-listed FX future | 100017.68 | 0.02 | 0.00 | 18.13 | 0.45 | 0.21 | 2 | 0 |
| 4 | @agri-trend | Exchange-listed commodity future | 100000.89 | 0.00 | 0.00 | 38.83 | 5.74 | 3031.40 | 11 | 0 |
...
| 11 | @perp-surfer | Kalshi perpetual future | 99998.92 | -0.00 | 0.00 | 218.47 | 332.11 | 81.13 | 10 | 28 |
| 12 | @barrel-rider | Kalshi event contract | 99996.89 | -0.00 | 0.00 | -5.28 | 1.90 | 4.99 | 3 | 0 |
| 13 | @carry-collector | Kalshi event contract | 99995.71 | -0.00 | 4.39 | -14.14 | 6.77 | 27.58 | 7 | 3 |
| 14 | @tail-rider | Kalshi event contract | 99993.07 | -0.01 | 0.00 | 0.00 | 0.55 | 3.80 | 1 | 0 |
| 15 | @book-watcher | Kalshi event contract | 99980.31 | -0.02 | -230.51 | 0.00 | 9.29 | 8.74 | 4 | 3 |
| 16 | @ladder-arb | Kalshi event contract | 99968.85 | -0.03 | -0.35 | 0.00 | 9.29 | 171.96 | 26 | 4 |
| 17 | @calendar-carry | Exchange-listed commodity future | 99957.68 | -0.04 | 0.00 | -6.37 | 35.33 | 8503.77 | 7 | 41 |
| 18 | @fade-the-crowd | Kalshi event contract | 99936.45 | -0.06 | 17.80 | -89.55 | 49.31 | 275.36 | 31 | 4 |
| 19 | @rig-count | Exchange-listed commodity future | 99928.58 | -0.07 | 0.00 | 647.29 | 5.77 | 637.70 | 15 | 0 |
| 20 | @index-mover | Exchange-listed equity index future | 99826.64 | -0.17 | 0.00 | -171.09 | 2.26 | 208.50 | 4 | 0 |
...
- **Result:** -0.06% (equity 99936.45 USD), 35 entries, 0 exits, 11 blocked order attempts.
- 35 ledger records so far: 6 distinct commodity exposures across kalshi.
- Closed-trade P&L is 0.00 USD against 49.31 USD of fees and 275.36 USD of measured slippage against the mid.
- 4 open positions carry verified marks totalling -89.55 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Blocked order attempts and their recorded reasons: settlement_result_not_published (11).
...
- **Result:** -0.00% (equity 99995.71 USD), 10 entries, 0 exits, 4 blocked order attempts.
- 10 ledger records so far: 3 distinct commodity exposures across kalshi.
- Closed-trade P&L is 0.00 USD against 6.77 USD of fees and 27.58 USD of measured slippage against the mid.
- 4 open positions carry verified marks totalling -14.14 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Blocked order attempts and their recorded reasons: insufficient_depth_within_price_tolerance (1), settlement_result_not_published (3).
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
- **Attribution by commodity:** Gold (3 trades, 0 USD realized, 0.67 USD fees); Gasoline (US retail average) (3 trades, 0 USD realized, 2.72 USD fees); WTI Crude Oil (4 trades, 0 USD realized, 3.38 USD fees)
...
- **Result:** 0.00% (equity 100000.00 USD), 0 entries, 0 exits, 30 blocked order attempts.
- No trade has been placed yet. The strategy is live and evaluating Kalshi event contract markets every tick.
- Orders it tried to place were not executed, for these recorded reasons: resting_order_registered (30). Each of those is a liquidity or data limitation of the real market, not a strategy result.
...
- **Result:** -0.03% (equity 99968.85 USD), 30 entries, 0 exits, 8 blocked order attempts.
...
- Blocked order attempts and their recorded reasons: already_holding (2), settlement_result_not_published (6).
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- 1 open positions carry verified marks totalling -5.28 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Result:** -0.00% (equity 99998.92 USD), 38 entries, 35 exits, 0 blocked order attempts.
- 73 ledger records so far: 11 distinct commodity exposures across kalshi_margin.
- Closed-trade P&L is -934.28 USD against 332.11 USD of fees and 81.13 USD of measured slippage against the mid.
...
- 11 open positions carry verified marks totalling 1020.74 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Result:** -0.04% (equity 99957.68 USD), 48 entries, 47 exits, 2 blocked order attempts.
- 95 ledger records so far: 5 distinct commodity exposures across moex_forts.
- Closed-trade P&L is -15.92 USD against 35.33 USD of fees and 8503.77 USD of measured slippage against the mid.
...
- 6 open positions carry verified marks totalling -6.37 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Blocked order attempts and their recorded reasons: no_verified_quote (2).
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
- **Attribution by commodity:** Cocoa (41 trades, 32.392234 USD realized, 24.619663 USD fees); Sugar (8 trades, -9.602457 USD realized, 0.183184 USD fees); Orange Juice (ORANGE) (30 trades, -73.997451 USD realized, 8.442458 USD fees); Raw Sugar (SUGR) (10 trades, 35.478281 USD realized, 1.760713 USD fees); Wheat (6 trades, -0.191883 USD realized, 0.324723 USD fees)
...
- 10 open positions carry verified marks totalling 38.83 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Result:** 0.17% (equity 100173.92 USD), 4 entries, 2 exits, 0 blocked order attempts.
...
- 2 open positions carry verified marks totalling 306.07 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- 8 open positions carry verified marks totalling 647.29 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Rules:** entry - 15-observation settlement momentum, |momentum| >= 1.5%.; exit - Exit when the momentum flips sign.
- **Result:** 0.02% (equity 100017.68 USD), 2 entries, 0 exits, 0 blocked order attempts.
...
- 2 open positions carry verified marks totalling 18.13 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Result:** -0.17% (equity 99826.64 USD), 4 entries, 0 exits, 0 blocked order attempts.
...
- 4 open positions carry verified marks totalling -171.09 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- Taker fills that walked the official ladder: 86
- Quote-based fills at the official bid/offer: 218
- Modelled resting maker fills: 0
- Orders that could not be executed, with the recorded reason: 55
  - resting_order_registered: 30
  - settlement_result_not_published: 20
  - no_verified_quote: 2
  - already_holding: 2
