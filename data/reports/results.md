...
Generated 2026-09-22T18:57:30.758Z from the committed ledger. Season n/a (? to ?), 0 ticks completed.
...
Independent verification: **0/0** trades fully verified, 0 anomalies (see `data/verification/report.json`).
