...
Generated 2026-09-25T10:05:38.793Z from the committed ledger. Season season-2026-09-22_to_2027-09-22 (2026-09-22T00:00:00Z to 2027-09-22T00:00:00Z), 18 ticks completed.
...
Independent verification: **307/459** trades fully verified, 152 anomalies (see `data/verification/report.json`).

## Leaderboard

| # | Username | Market type | Equity (USD) | Return % | Realized | Unrealized | Fees | Slippage | Open | Closed trades |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | @metal-trend | Exchange-listed commodity future | 101012.47 | 1.01 | 0.00 | 1019.04 | 6.57 | 676.33 | 12 | 0 |
| 2 | @basis-hunter | Cross-venue: Kalshi perpetual future vs exchange-listed future | 100156.59 | 0.16 | 0.00 | 289.20 | 24.51 | 87.27 | 1 | 3 |
| 3 | @index-mover | Exchange-listed equity index future | 100014.97 | 0.01 | 0.00 | 17.24 | 2.26 | 208.50 | 4 | 0 |
...
| 10 | @perp-surfer | Kalshi perpetual future | 99998.92 | -0.00 | 0.00 | 49.87 | 529.13 | 124.17 | 9 | 50 |
| 11 | @barrel-rider | Kalshi event contract | 99996.89 | -0.00 | 0.00 | -0.21 | 3.69 | 11.83 | 5 | 0 |
| 12 | @carry-collector | Kalshi event contract | 99995.71 | -0.00 | -38.46 | 0.00 | 16.69 | 57.62 | 20 | 6 |
| 13 | @tail-rider | Kalshi event contract | 99993.07 | -0.01 | 0.00 | 0.00 | 1.13 | 4.87 | 3 | 0 |
| 14 | @book-watcher | Kalshi event contract | 99980.31 | -0.02 | -230.51 | 0.00 | 15.89 | 13.67 | 10 | 3 |
| 15 | @ladder-arb | Kalshi event contract | 99968.85 | -0.03 | -27.49 | -2.07 | 22.75 | 494.44 | 30 | 10 |
| 16 | @fade-the-crowd | Kalshi event contract | 99936.45 | -0.06 | 251.74 | -5.21 | 57.84 | 350.10 | 37 | 17 |
| 17 | @rig-count | Exchange-listed commodity future | 99928.58 | -0.07 | 0.00 | -121.37 | 5.88 | 892.70 | 16 | 0 |
| 18 | @agri-trend | Exchange-listed commodity future | 99886.72 | -0.11 | 0.00 | -107.53 | 5.74 | 3031.40 | 11 | 0 |
| 19 | @usd-rub-desk | Exchange-listed FX future | 99878.31 | -0.12 | 0.00 | -121.25 | 0.45 | 0.21 | 2 | 0 |
| 20 | @calendar-carry | Exchange-listed commodity future | 99803.67 | -0.20 | 0.00 | -13.43 | 50.25 | 8763.76 | 5 | 61 |
...
- **Result:** -0.06% (equity 99936.45 USD), 54 entries, 0 exits, 33 blocked order attempts.
...
- 2 open positions carry verified marks totalling -5.21 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
...
- **Result:** 0.00% (equity 100000.00 USD), 0 entries, 0 exits, 47 blocked order attempts.
- No trade has been placed yet. The strategy is live and evaluating Kalshi event contract markets every tick.
- Orders it tried to place were not executed, for these recorded reasons: resting_order_registered (47). Each of those is a liquidity or data limitation of the real market, not a strategy result.
...
- 2 open positions carry verified marks totalling -2.07 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
...
- 1 open positions carry verified marks totalling -0.21 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Result:** -0.00% (equity 99998.92 USD), 59 entries, 70 exits, 0 blocked order attempts.
- 129 ledger records so far: 11 distinct commodity exposures across kalshi_margin.
- Closed-trade P&L is -1750.75 USD against 529.13 USD of fees and 124.17 USD of measured slippage against the mid.
...
- **Result:** 1.01% (equity 101012.47 USD), 12 entries, 0 exits, 0 blocked order attempts.
...
- 12 open positions carry verified marks totalling 1019.04 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Result:** -0.20% (equity 99803.67 USD), 66 entries, 71 exits, 7 blocked order attempts.
- 137 ledger records so far: 5 distinct commodity exposures across moex_forts.
- Closed-trade P&L is -154.14 USD against 50.25 USD of fees and 8763.76 USD of measured slippage against the mid.
...
- 5 open positions carry verified marks totalling -13.43 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Blocked order attempts and their recorded reasons: no_verified_quote (7).
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
- **Attribution by commodity:** Cocoa (57 trades, -36.061199 USD realized, 34.193257 USD fees); Sugar (8 trades, -9.602457 USD realized, 0.183184 USD fees); Orange Juice (ORANGE) (42 trades, -99.488359 USD realized, 11.136864 USD fees); Raw Sugar (SUGR) (18 trades, -13.5846 USD realized, 4.086887 USD fees); Wheat (12 trades, 4.601231 USD realized, 0.649485 USD fees)
...
- **Result:** -0.11% (equity 99886.72 USD), 11 entries, 0 exits, 0 blocked order attempts.
...
- 11 open positions carry verified marks totalling -107.53 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Result:** 0.16% (equity 100156.59 USD), 4 entries, 3 exits, 1 blocked order attempts.
...
- 1 open positions carry verified marks totalling 289.20 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
...
- 11 open positions carry verified marks totalling -121.37 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Rules:** entry - 15-observation settlement momentum, |momentum| >= 1.5%.; exit - Exit when the momentum flips sign.
- **Result:** -0.12% (equity 99878.31 USD), 2 entries, 0 exits, 0 blocked order attempts.
...
- 2 open positions carry verified marks totalling -121.25 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- **Result:** 0.01% (equity 100014.97 USD), 4 entries, 0 exits, 0 blocked order attempts.
...
- 4 open positions carry verified marks totalling 17.24 USD unrealised; positions whose exit price could not be read from the book are reported as null rather than estimated.
- Verdict: not yet statistically meaningful - a one-year season is the measurement window, and the report states only what the ledger shows.
...
- Taker fills that walked the official ladder: 141
- Quote-based fills at the official bid/offer: 318
- Modelled resting maker fills: 0
- Orders that could not be executed, with the recorded reason: 143
  - settlement_result_not_published: 85
  - resting_order_registered: 47
  - no_verified_quote: 8
  - already_holding: 2
